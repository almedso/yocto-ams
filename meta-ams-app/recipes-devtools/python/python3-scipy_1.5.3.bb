...
SRC_URI += " file://0001-Allow-passing-flags-via-FARCH-for-match.patch"
...
# Get rid of package QA issues of bad RPATH  did not help
EXTRA_OECMAKE += "-DCMAKE_SKIP_BUILD_RPATH:BOOLEAN=True"
EXTRA_OECMAKE += "-DCMAKE_BUILD_WITH_INSTALL_RPATH:BOOLEAN=False"
EXTRA_OECMAKE += "-DCMAKE_INSTALL_RPATH_USE_LINK_PATH:BOOLEAN=False"
